...
\author[Alexander Voigt]{Emanuele Bagnaschi, \underline{Alexander Voigt}, Georg Weiglein [17xx.yyyyy]}
...
\begin{frame}{Observations}
  ...
  \item 2HDM-II uncertainty \emph{important}:
    ...
    \end{align*}
  \item EFT uncertainty negligible for $\MS \gtrsim 2\eh{TeV}$
  \item SUSY uncertainty negligible
  \end{itemize}
\end{frame}
...
\begin{frame}{Effect from non-degenerate spectra}
  Variation of the mass parameters by factor 2:\\[1em]
...
\begin{frame}{Summary}
  ...
  \item aim for honest uncertainty estimate\\ 4 sources:
    ...
    \item EFT uncertainty (negligible for $\MS \gtrsim 2\eh{TeV}$)
    \item SUSY uncertainty (negligible here)
    \end{itemize}
  \end{itemize}
\end{frame}
